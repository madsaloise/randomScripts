Function Start-QMCTask {
    param(
        ...
        [Parameter(Mandatory=$false, HelpMessage = "Optionel. Den QV-Server, som der skal forbindes til. Eksempel: QlikView.ServerName.net")][string]$Hostname
        )
...
Start-QMCTask -documentName "Tilhold.qvw" -Hostname "QlikView.ServerName.net"
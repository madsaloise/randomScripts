class QRSClient {
    <#
    .SYNOPSIS
        Client class for Qlik Sense QRS (Repository Service) API
    
    .DESCRIPTION
        Provides a structured interface for making REST API calls to Qlik Sense QRS.
        Handles authentication, XRF key generation, TLS configuration, and certificate validation.
    #>

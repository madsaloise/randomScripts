...
local AUTO_SHOT_IDS = addon_data.spells.GetSpellIDs(L"Auto Shot")
local SHOOT_IDS = addon_data.spells.GetSpellIDs(L"Shoot")
...
function addon_data.hunter.OnUnitSpellCastSucceeded(unit, spell_id)
    if unit == "player" then
        ...
        if addon_data.hunter.shot_spell_ids[spell_id] then
            local name = addon_data.hunter.shot_spell_ids[spell_id].name

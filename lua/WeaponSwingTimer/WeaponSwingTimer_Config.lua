...
function addon_data.config.InitializeVisuals()
    ...
    panel.config_druid_panel.default = addon_data.config.OnDefault
...
function addon_data.config.CheckBoxFactory(g_name, parent, checkbtn_text, tooltip_text, on_click_func, scale)
